...
(define-module (accessibility-everywhere meta)
...
(define architecture-decisions
  '((adr-001
     ...
     (status . "accepted")
     (date . "2025-12-15")
     (context . "> Making web accessibility a search engine ranking factor")
...
(define development-practices
  '((code-style
     (languages . ("CSS" "HTML" "JavaScript" "Just" "Nix" "PHP" "Scheme" "Shell" "TypeScript"))
