...
:experimental:
:url-github: https://github.com/hyperpolymath/accessibility-everywhere
:url-gitlab: https://gitlab.com/hyperpolymath/accessibility-everywhere
:url-bitbucket: https://bitbucket.org/hyperpolymath/accessibility-everywhere
:url-codeberg: https://codeberg.org/hyperpolymath/accessibility-everywhere

Universal accessibility toolkit for web and desktop applications
...
accessibility-everywhere is part of the link:https://rhodium.sh[Rhodium Standard] (RSR) ecosystem.
