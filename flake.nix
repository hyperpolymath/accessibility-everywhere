{
  description = "accessibility-everywhere - {project-description}";
      ...
      in
      {
        ...
        packages.default = pkgs.stdenv.mkDerivation {
          ...
          buildPhase = ''
            ...
            # For Ada: gprbuild -P accessibility-everywhere.gpr -XMODE=release
          '';

          installPhase = ''
            mkdir -p $out/bin
            # *REMINDER: Add install commands*
            # cp target/release/accessibility-everywhere $out/bin/  # Rust
            # cp bin/accessibility-everywhere $out/bin/  # Ada
          '';
        ...
        apps.default = {
          type = "app";
          program = "${self.packages.${system}.default}/bin/accessibility-everywhere";
        };
        ...
        checks = {
          ...
          test = pkgs.runCommand "test-accessibility-everywhere" {
